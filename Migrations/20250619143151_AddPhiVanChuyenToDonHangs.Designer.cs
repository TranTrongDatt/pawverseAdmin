...
namespace PawVerse.Migrations
{
    ...
    [Migration("20250619143151_AddPhiVanChuyenToDonHangs")]
    partial class AddPhiVanChuyenToDonHangs
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PawVerse.Models.DonHang", b =>
                {
                    ...
                    b.HasOne("PawVerse.Models.ApplicationUser", "NguoiDung")
                        .WithMany("DonHangs")
                        .HasForeignKey("IdNguoiDung")
                        .IsRequired()
                        .HasConstraintName("FK__DonHang__ID_Nguo__6D0D32F4");

                    b.HasOne("PawVerse.Models.VanChuyen", "VanChuyen")
                        .WithMany("DonHangs")
